...
excerpt: "I developed a low-level firmware on ESP32 to interact with BNO086x Inertia Measurement Unit (IMU) at register level;  I optimized the sensor data streaming by 200% (at 200Hz) while keeping three different sensors data synchronized. I also applied FreeRTOS and it properties like priorities, along with dual-core on ESP32, to optimized the data streaming and plotting process."
order: 2
